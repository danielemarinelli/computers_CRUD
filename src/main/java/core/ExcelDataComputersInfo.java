...
public class ExcelDataComputersInfo {

    public static List<Map<String, String>> getTestDataFromComputersInfoFile() throws IOException {
        List<Map<String,String>> testDataAllRows=null;
        Map<String,String> testData=null;
        FileInputStream fileInputStream=new FileInputStream("./src/main/resources/testdata/DataComputersInfo.xlsx");
        Workbook workbook=new XSSFWorkbook(fileInputStream);
        Sheet sheet=workbook.getSheet("PC");
